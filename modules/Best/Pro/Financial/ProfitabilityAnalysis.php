...
abstract class ProfitabilityAnalysis extends AbstractAnalysis
{
    ...
    public static function getBC4Comment($spreadsheet)
    {
        ...
        $h21 = $spreadsheet->getCell('H21')->getCalculatedValue();
    ...
    public static function getBD4Comment($spreadsheet)
    {
        ...
        $h19 = $spreadsheet->getCell('H19')->getCalculatedValue();
        $h20 = $spreadsheet->getCell('H20')->getCalculatedValue();
        $h21 = $spreadsheet->getCell('H21')->getCalculatedValue();
    ...
    public static function getBC5Comment($spreadsheet)
    {
        ...
        $k21 = $spreadsheet->getCell('K20')->getCalculatedValue();
    ...
    public static function getBD5Comment($spreadsheet)
    {
        ...
        $k19 = $spreadsheet->getCell('K19')->getCalculatedValue();
        $k20 = $spreadsheet->getCell('K20')->getCalculatedValue();
        $k21 = $spreadsheet->getCell('K21')->getCalculatedValue();
    ...
    public static function getBC6Comment($spreadsheet)
    {
        ...
        $n21 = $spreadsheet->getCell('N21')->getCalculatedValue();
    ...
    {
        $output = '';
        $bk7 = $spreadsheet->getCell('BK7')->getCalculatedValue();
        $q19 = $spreadsheet->getCell('Q19')->getCalculatedValue();
        $q20 = $spreadsheet->getCell('Q20')->getCalculatedValue();
        $d19 = $spreadsheet->getCell('D19')->getCalculatedValue();
        $d20 = $spreadsheet->getCell('D20')->getCalculatedValue();
    ...
    public static function getBD8Comment($spreadsheet)
    {
        $output = '';
        $t19 = $spreadsheet->getCell('T19')->getCalculatedValue();
        $t20 = $spreadsheet->getCell('T20')->getCalculatedValue();
        $t21 = $spreadsheet->getCell('T21')->getCalculatedValue();
        $bj8 = $spreadsheet->getCell('BJ8')->getCalculatedValue();
        if ($t19 == "" && ($t21-$t20) > 0) {
            if (($t21-$t20)>$bj8) {
    ...
    public static function getBE8Comment($spreadsheet)
    {
        ...
        $bk8 = $spreadsheet->getCell('BK8')->getCalculatedValue();
        $d19 = $spreadsheet->getCell('D19')->getCalculatedValue();
        $d20 = $spreadsheet->getCell('D20')->getCalculatedValue();
        $t19 = $spreadsheet->getCell('T19')->getCalculatedValue();
        $t20 = $spreadsheet->getCell('T20')->getCalculatedValue();

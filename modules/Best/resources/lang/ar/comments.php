...
return [
    'fmpi' => [
        ...
        'first' => [
            'based on responses' => "استنادا إلى الردود على البيانات الفردية الواردة في الدراسة الاستقصائية للإدارة المالية، تم تنفيذ  :item1 و  ':item2' على أفضل وجه",
        ...
        'lowest' => ":item1 محوري التركيز المباشر لضمان وجود منظمة سليمة ذات أهداف مستدامة طويلة الاجل."
    ],
    ...
    'bspi' => [
        ...
        'first' => [
            'based on responses' => "واستنادا إلى الردود على البيانات الفردية المتعلقة باستدامة الأعمال التجارية، تم تنفيذ ':item1' و  ':item2' على أفضل وجه",

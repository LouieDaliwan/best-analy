...
return [
    ...
    'documentation' => [
        'greaterThan90' => ':name has been found to have an excellent documentation practice, always ready for any form of internal or external financial audits.',
        ...
        'less30' => 'The analysis suggest that serious intervention is required to ensure that a more organized documentation relating to finance procedures and processes is needed to be implemented in the short run.'
    ],
    'talent' => [
        'greaterThan90' => ":name has an excellent employee development & management practices to ensure financial matters are well understood across the organisation.",
        ...
        '30to50' => 'Further analysis seemed to suggest that employees would welcome improved financial management practices to implement existing financial processes. Hence, it will be good for the organization to focus on how areas such as :item1, & :item2, can be improved.',
        ...
        'less30' => 'Further analysis seemed to suggest that employees are somewhat unhappy with the lack of clarity in finance roles and capacity development. More can be done across all areas impacting employees directly to improve overall financial management practices.',
    ],
    'technology' => [
        'greaterThan90' => ':name has an excellent ICT implementation & poised for further organic or inorganic growth.',
        ...
        '30to50' => 'In addition to that, there is also a good ICT system in place which can still be better operationalised. :name should focus on how the system is being streamlined to be more purposeful and reflect better usability, especially in terms of :item1 & :item2.',
        ...
        'less30' => 'While financial tools and sytems are not observed, it has to be noted that more can be done to ensure that appropriate solutions are considered soonest to ensure it support a smoother financial administration for the organization.'
    ],
    'workflow' => [
        'greaterThan90' => ':name has an excellent workflow processes which will lay sustainable foundation for future growth.',
        ...
        "30to50" => "Finally, the workflow processes within :name have shown positive effect to the operations. However, it is noted that more can still be done to enhance how these are executed such as :item1 & :item2.",
        ...
        'less30' => "Finally, the analysis reflected a lack of clear financial processes and practices. Immediate attention needs to be given to ensure a more systematic work process are in place to better facilitate the organization's operations.	"
    ],
];

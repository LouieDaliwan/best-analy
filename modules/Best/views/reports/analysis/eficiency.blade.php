    ...
    <tr>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td>
              <div class="card my-3">
                <div class="card-body">
                  @foreach ($data['analysis:financial']['efficiency']['comments'] as $comment)
                    <p>@lang($comment)</p>
                  @endforeach
                </div>
              </div>
      ...
      <td width="320" valign="center">
        <table cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td>
              <canvas height="100" class="my-3" id="Eficiency"></canvas>
            </td>
          </tr>
        </table>
      </td>
...
$(document).ready(function() {
  var ctx = document.getElementById("Eficiency").getContext('2d');
  var chartColors = {

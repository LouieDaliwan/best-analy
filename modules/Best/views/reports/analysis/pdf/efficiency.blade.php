...
<section>
  <div class="row">
    <div class="col-md-12">
      <div class="analysis-title">
        <h1 class="mb-5 dt-secondary">@lang('Efficiency Analysis')</h1>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-12 chart-analysis">
      <div class="card mb-5">
        <div class="card-body">
          <canvas width="100%" id="efficiency"></canvas>
        </div>
      </div>
    </div>
    <div class="col-md-12 comment-analysis">
      @foreach ($data['analysis:financial']['efficiency']['comments'] as $comments)

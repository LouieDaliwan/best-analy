...
<section>
  <div class="row">
    <div class="col-md-12">
      <div class="analysis-title">
        <h1 class="mb-5 dt-secondary">@lang('Solvency Analysis')</h1>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-12 chart-analysis">
      <div class="card mb-5">
        <div class="card-body">
          <canvas width="100%" id="solvency"></canvas>
        </div>
      </div>
    </div>
    <div class="col-md-12 comment-analysis">
      @foreach ($data['analysis:financial']['solvency']['comments'] as $comments)
        <div class="d-flex align-items-start">
          <div>
            <span class="mr-3" style="font-size: 10px;">
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512; margin-bottom: 6px;" xml:space="preserve" width="10px" height="10px"><g><g>
                <g>
...
$(document).ready(function() {
  ...
  var dataset = {!! json_encode($data['analysis:financial']['solvency']['charts']['dataset']) !!}
  ...
  var barChart = new Chart(ctx, {
    ...
    data: {
      labels: {!! json_encode(collect(
        $data['analysis:financial']['solvency']['charts']['labels'])->values()->toArray()
      ) !!},
      datasets: dataset,
    },
    options: {

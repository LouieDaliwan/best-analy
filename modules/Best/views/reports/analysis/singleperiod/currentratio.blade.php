...
<section>
  <div class="row">
    <div class="col-md-12">
      <div>
        <h1 class="mb-3 dt-secondary">@lang('Current Ratio Score')</h1>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-12 chart-analysis">
      <div class="card mb-5">
        <div class="card-body">
          <canvas height="100" id="current_ratio"></canvas>
        </div>
      </div>
    </div>
    <div class="col-md-12 comment-analysis">
        <div class="row">
          ...
          <div class="col">
              <p>{{ $data['analysis:financial']['current_ratio']['comment'][0] }}</p>
          </div>
        </div>
    </div>
  </div>
...
$(document).ready(function() {
  var ctx = document.getElementById("current_ratio").getContext('2d');
  var chartColors = {
  ...
  var labels = {!!  json_encode(collect($data['analysis:financial']['current_ratio']['chart']['labels']['preview'])->values()->toArray()); !!}

...
<section>
  ...
  <div class="row">
    <div class="col-md-12 chart-analysis">
      <div class="card mb-5">
        <div class="card-body">
          <canvas height="100" id="net_margin"></canvas>
        </div>
      </div>
    </div>
    <div class="col-md-12 comment-analysis">
        <div class="row">
          ...
          <div class="col">
              <p>{{ $data['analysis:financial']['net_margin']['comment'][0] }}</p>
          </div>
        </div>
    </div>
  </div>
...
$(document).ready(function() {
  ...
  var labels = {!!  json_encode(collect($data['analysis:financial']['net_margin']['chart']['labels']['preview'])->values()->toArray()); !!}

...
<section>
  ...
  <div class="row">
    <div class="col-md-12 chart-analysis">
      <div class="card mb-5">
        <div class="card-body">
          <canvas height="100" id="raw_materials"></canvas>
        </div>
      </div>
    </div>
    <div class="col-md-12 comment-analysis">
        <div class="row">
          ...
          <div class="col">
              <p>{{ $data['analysis:financial']['raw_materials']['comment'][0] }}</p>
          </div>
        </div>
    </div>
  </div>
...
$(document).ready(function() {
  ...
  var labels = {!!  json_encode(collect($data['analysis:financial']['raw_materials']['chart']['labels']['preview'])->values()->toArray()); !!}

<canvas height="120" class="my-3" id="bspi-score"></canvas>
...
$(document).ready(function() {
  var ctx = document.getElementById("bspi-score").getContext('2d');
  var chartColors = {
  ...
  var barChart = new Chart(ctx, {
    type: 'line',
    data: {
      labels: {!! json_encode(collect($data['indices']['BSPI']['elements:charts']['labels'])->values()->toArray()) !!},
      datasets: [
        {

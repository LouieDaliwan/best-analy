<canvas height="120" class="my-3" id="pmpi-score"></canvas>
...
$(document).ready(function() {
  var ctx = document.getElementById("pmpi-score").getContext('2d');
  var chartColors = {
  ...
  var barChart = new Chart(ctx, {
    type: 'line',
    data: {
      labels: {!! json_encode(collect($data['indices']['PMPI']['elements:charts']['labels'])->values()->toArray()) !!},
      datasets: [
        {

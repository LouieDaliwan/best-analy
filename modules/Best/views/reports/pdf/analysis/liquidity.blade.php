<section class="mt-3">
  <h3 class="dt-secondary">@lang('Liquidity Analysis')</h3>
    ...
    <tr>
      <td valign="top" width="50%">
        <div class="comment-analysis">
          <table>
            @foreach ($data['analysis:financial']['liquidity']['comments'] as $key => $comments)
              @if(! empty($data['analysis:financial']['liquidity']['comments'][$key]))
                <tr>
                  <td valign="top">
                    <div class="mr-3">
                      @if (app()->getLocale() == 'ar' && ! empty($data['analysis:financial']['liquidity']['comments'][$key]))
                        <div class="ml-3">
                      ...
                      @endif
                      @if (app()->getLocale() == 'en' && ! empty($data['analysis:financial']['liquidity']['comments'][$key]))
                        <span style="font-size: 17px;">
      ...
      <td valign="top" width="50%">
        <div class="chart-analysis">
          <div style="width: 800px; height: 200px;">
            <canvas id="liquidity" style="width: 800px; height: 200px;"></canvas>
          </div>
        </div>
        ...
        <table align="center" width="50%">
          <tr>
            @foreach ($data['analysis:financial']['liquidity']['chart']['dataset'] as $resource)
              <td>

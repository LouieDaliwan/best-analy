<section class="mt-3">
  <h3 class="dt-secondary">@lang('Productivity Analysis')</h3>

  <table width="100%">
    <tr>
      <td valign="top" width="50%">
        <div class="chart-analysis">
          <div class="mr-3" style="width: 700px; height: 300px;">
            <canvas id="productivity" style="width: 700px; height: 300px;"></canvas>
          </div>
        </div>
            ...
            @foreach ($data['analysis:financial']['productivity']['comments'] as $key => $comments)
              @if(! empty($data['analysis:financial']['productivity']['comments'][$key]))
                <tr>
                  <td valign="top">
                    <div class="mr-3">
                      @if (app()->getLocale() == 'ar' && ! empty($data['analysis:financial']['productivity']['comments'][$key]))
                        <div class="ml-3">
                      ...
                      @endif
                      @if (app()->getLocale() == 'en' && ! empty($data['analysis:financial']['productivity']['comments'][$key]))
                        <span style="font-size: 17px;">

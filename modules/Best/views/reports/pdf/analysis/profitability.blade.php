    ...
    <tr>
      <td valign="top" width="40%">
        <div class="chart-analysis">
          <div class="mr-3" style="width: 850px; height: 400px;">
            <canvas id="profitability" style="width: 850px; height: 400px;"></canvas>
          </div>
        </div>
    ...
    options: {
      animation: {
        ...
        onComplete: function () {
            ...
            ctx.font = Chart.helpers.fontString('2px', Chart.defaults.global.defaultFontStyle, Chart.defaults.global.defaultFontFamily);

...
<div class="mx-4 mb-5">
@endif
  <h3 class="dt-BSPI py-2 text-center"style="border-bottom: 1px solid #f5f5f5;">{{ __('Debt Ratio') }}</h3>
    <div style="zoom: 0.76;">
      <div class="mb-3 text-center">
        <canvas height="260" width="550" id="debt_ratio" style="margin: auto;" class="mt-5 mb-2"></canvas>
      </div>
    </div>
    <p class="mb-0 text-center">
      @if (app()->getLocale() == 'ar')
        ...
        @endif
      {{ $data['analysis:financial']['debt_ratio']['comment'][0] }}
    </p>
</div>

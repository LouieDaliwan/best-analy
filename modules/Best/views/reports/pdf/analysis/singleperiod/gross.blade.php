@if(app()->getLocale() == 'ar')
<div class="mx-4 mb-5" style="width: 380px; word-break: break-all;">
@else
<div class="mx-4 mb-5">
@endif
  <h3 class="dt-BSPI py-2 text-center"style="border-bottom: 1px solid #f5f5f5;">{{ __('Gross Margin') }}</h3>
    <div style="zoom: 0.76;">
      <div class="mb-3 text-center">
        <canvas height="260" width="550" id="gross_ratio" style="margin: auto;" class="mt-5 mb-2"></canvas>
      </div>
    </div>
    <p class="mb-0">
      @if (app()->getLocale() == 'ar')
        ...
        @endif
      {{ $data['analysis:financial']['gross_ratio']['comment'][0] }}
    </p>
</div>

<script>
  $(document).ready(function() {
    var ctx = document.getElementById("gross_ratio").getContext('2d');
    var chartColors = {
    ...
    var dataset = {!! json_encode($data['analysis:financial']['gross_ratio']['chart']['dataset']) !!}
    var labels = {!!  json_encode(collect($data['analysis:financial']['gross_ratio']['chart']['labels']['pdf'])->values()->toArray()); !!}

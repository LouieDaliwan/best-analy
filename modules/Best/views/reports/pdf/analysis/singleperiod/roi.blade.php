...
<div class="mx-4 mb-5">
@endif
  <h3 class="dt-BSPI py-2 text-center"style="border-bottom: 1px solid #f5f5f5;">{{ __('ROI') }}</h3>
    <div style="zoom: 0.76;">
      <div class="mb-3 text-center">
        <canvas height="260" width="550" id="roi" style="margin: auto;" class="mt-5 mb-2"></canvas>
      </div>
    </div>
    <p class="mb-0">
      @if (app()->getLocale() == 'ar')
...
<script>
  $(document).ready(function() {
    ...
    var labels = {!!  json_encode(collect($data['analysis:financial']['roi']['chart']['labels']['pdf'])->values()->toArray()); !!}

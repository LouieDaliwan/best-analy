<section class="mt-3">
  <h3 class="dt-secondary">@lang('Solvency Analysis')</h3>
            ...
            @foreach ($data['analysis:financial']['solvency']['comments'] as $key => $comments)
              @if(! empty($data['analysis:financial']['solvency']['comments'][$key]))  
                <tr>
                  <td valign="top">
                    <div class="mr-3">
                      @if (app()->getLocale() == 'ar' && ! empty($data['analysis:financial']['solvency']['comments'][$key]))
                        <div class="ml-3">
                      ...
                      @endif
                      @if (app()->getLocale() == 'en' && ! empty($data['analysis:financial']['solvency']['comments'][$key]))
                        <span style="font-size: 17px;">
      ...
      <td valign="top" width="50%">
        <div class="chart-analysis">
          <div class="mr-3" style="width: 700px; height: 200px;">
            <canvas id="solvency" style="width: 700px; height: 200px;"></canvas>
          </div>
        </div>
        ...
        <table align="center" width="50%">
          <tr>
            @foreach ($data['analysis:financial']['solvency']['charts']['dataset'] as $resource)
              <td>

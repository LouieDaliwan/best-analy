...
<head>
  ...
  {{-- Chart --}}
  <!-- <script>{!! file_get_contents('https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.1/jquery.min.js') !!}</script>
  <script>{!! file_get_contents('https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.6.0/Chart.bundle.min.js') !!}</script> -->

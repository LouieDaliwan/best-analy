...
<section class="mt-2">
  ...
  <table width="100%" class="mb-5" style="border-spacing: 10px; border-collapse: separate;">
    <tr>
      <td width="50%" style="vertical-align: top;">
        <table width="100%">
          <tr>
            <td class="p-2">
              <h4 class="dt-secondary mb-0">@lang('best::reports.:appcode Score', ['appcode' => __(settings('app:code'))])</h4>
            </td>
            <td class="p-2">

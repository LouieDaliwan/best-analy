        ...
        <div class="mx-3" style="width: 200px; height: 200px;">
          <svg width="100%" height="100%" viewBox="0 0 42 42" class="donut">
            ...
            <circle class="donut-segment" transform="rotate(-90 0 0)
                translate(-42 0)" cx="21" cy="21" r="15.91549430918954" fill="transparent" stroke="{{ $data['pindex:color'] }}" stroke-dasharray="{{ round($data['overall:total']) }} {{ 100 - round($data['overall:total']) }}" stroke-dashoffset="25" stroke-width="3"></circle>
            <g class="chart-text">

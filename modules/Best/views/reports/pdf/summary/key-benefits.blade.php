...
<section>
  <div class="row">
    <div class="col-md-12">
      <p class="dt-primary mb-1 font-weight-bold">@lang('Key Benefits')</p>
      @foreach (trans('best::reports.benefits') as $key => $benefit)
        <p class="mb-0">
          {{-- SVG arrow --}}
          @if (app()->getLocale() == 'ar')
            <span class="ml-2" style="font-size: 13px;">
              <svg width="13px" height="13px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                <g>
                  <g>

...
class Profitability
{
    public static function compute($profitability, $sales, $profitStatements, $balanceSheets)
    {
        ...
        $profitability['gross_profit_margin'] = $sales != 0 ? round((($sales - $profitStatements['cost_goods']) / $profitStatements['cost_goods']) * 100, 2) : 0;
        ...
        $profitability['return_on_equity'] = $stock_holder !=  0 ? round(($profitStatements['net_loss_profit_after_taxes'] / $stock_holder), 2) : 0;

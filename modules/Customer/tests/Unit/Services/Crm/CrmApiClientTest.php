...
namespace Customer\Unit\Services\Crm;

use Customer\Services\Crm\CrmApiClient;
 ...
 */
class CrmApiClientTest extends TestCase
{
    /**
     * @test
     * @group  unit
    ...
    public function it_can_return_the_response_object_when_calling_a_get_request()
    {
        ...
        $client = new CrmApiClient(new Client(['handler' => $handlerStack]));

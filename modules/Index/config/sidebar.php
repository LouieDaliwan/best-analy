    ...
    'module:index' => [
        ...
        'children' => [
            'view-indices' => [
                'name' => 'view-indices',
                'order' => 1,
                'route:name' => 'indices.index',
                'permissions' => ['indices.index'],
                'text' => 'All Indices',
                'description' => 'View the list of all indices',
            ],
            'create-index' => [
                'name' => 'create-index',
                'order' => 2,
                'route:name' => 'indices.create',
                'permissions' => ['indices.create', 'indices.store'],
                'text' => 'Create Index',
            ...
            'trashed-index' => [
                'name' => 'trashed-index',
                'order' => 3,
                'route:name' => 'indices.trashed',
                'permissions' => ['indices.trashed'],
                'text' => 'Trashed Indices',
                'description' => 'View list of all indices moved to trash',
            ],
        ],
    ],
];

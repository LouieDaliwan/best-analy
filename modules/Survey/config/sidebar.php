    ...
    'module:survey' => [
        ...
        'children' => [
            'view-surveys' => [
                'name' => 'view-surveys',
                'order' => 1,
                'route:name' => 'surveys.index',
                'permissions' => ['surveys.index'],
                'text' => 'All Surveys',
                'description' => 'View the list of all surveys',
            ],
            'create-survey' => [
                'name' => 'create-survey',
                'order' => 2,
                'route:name' => 'surveys.create',
                'permissions' => ['surveys.create', 'surveys.store'],
                'text' => 'Create Survey',
            ...
            'trashed-survey' => [
                'name' => 'trashed-survey',
                'order' => 3,
                'route:name' => 'surveys.trashed',
                'permissions' => ['surveys.trashed'],
                'text' => 'Trashed Surveys',
                'description' => 'View list of all surveys moved to trash',
            ],
        ],
    ],
];

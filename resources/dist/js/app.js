...
/*!
  ...
  */
(function (global, factory) {
   true ? module.exports = factory(__webpack_require__(0), __webpack_require__(159)) :
  undefined;
...
module.exports = function(list) {
  ...
  var Item = __webpack_require__(14)(list);
...
var classes = __webpack_require__(6),
  ...
  getByClass = __webpack_require__(9),
  fuzzy = __webpack_require__(171);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _treeview_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(173);
/* harmony import */ var _treeview_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_treeview_css__WEBPACK_IMPORTED_MODULE_0__);
...
$(document).on('change', '[data-tree-child] [data-tree-checkbox]', function (e) {
  var $parent = $(this).parents('[data-tree-child]').parents('[data-tree-item]');
  var $children = $parent.children('[data-tree-child]').find('input[type=checkbox]').length;
  var $checked = $parent.children('[data-tree-child]').find('input[type=checkbox]:checked').length;
...
$(document).ready(function () {
  var $tree = $(document).find('[data-tree]');
  $tree.find('[data-tree-child]').each(function (i, el) {
    var $child = $(el);
    var $children = $child.find('input[type=checkbox]').length;
    var $checked = $child.find('input[type=checkbox]:checked').length;
    var $parent = $child.parents('[data-tree-item]');
    var $header = $parent.children('[data-tree-header]');
...
$(document).on('click', '[data-tree-toggle]', function (e) {
  var $parent = $(this).parents('.treeview');
  var $instance = $parent.find('[data-tree]');
...
var bootstrap = __webpack_require__(144);
...
// EXTERNAL MODULE: ./src/components/avatar/avatar-upload.scss
var avatar_upload = __webpack_require__(147);

// CONCATENATED MODULE: ./src/components/avatar/avatar-upload.js
...
function readURL(input) {
  if (input.files && input.files[0]) {
    ...
    reader.onload = function (e) {
      jquery_default()(input).closest('[data-avatar]').find('[data-avatar-preview]').css('background-image', 'url(' + e.target.result + ')');
      jquery_default()(input).closest('[data-avatar]').find('[data-avatar-preview]').hide();
      jquery_default()(input).closest('[data-avatar]').find('[data-avatar-preview]').fadeIn(650);
      jquery_default()(input).closest('[data-avatar]').find('[data-avatar-cancel]').fadeIn(230);
    };
...
jquery_default()('[data-avatar-upload]').change(function () {
  readURL(this);
});
jquery_default()(document).on('click', '[data-avatar-cancel]', function (e) {
  var $parent = jquery_default()(this).closest('[data-avatar]');
  $parent.find('[data-avatar-preview]').css('background-image', 'none');
  $parent.find('[data-avatar-cancel]').fadeOut(230);
  $parent.find('[type=file]').val('');
  jquery_default()(this).trigger('avatar:remove');
  e.preventDefault();
});
...
jquery_default()(document).ready(function () {
  jquery_default()(document).on('change', '[data-avatar-preview-target]', function () {
    var target = jquery_default()(this).data('avatar-preview-target');
    var value = jquery_default()(this).val();
    var $target = jquery_default()(target);
    $target.attr('src', value);
  });
  jquery_default()(document).find('[data-avatar-preview-remove]').on('click', function () {
    var $avatar = jquery_default()(this).parents('[data-avatar]');
    var target = $avatar.find('[data-avatar-preview-target]').data('avatar-preview-target');
    jquery_default()(target).attr('src', '');
    $avatar.find('[data-avatar-preview-target]').val('').trigger('change');
  });
});
// EXTERNAL MODULE: ./src/components/photo/photo-upload.scss
var photo_upload = __webpack_require__(149);

// CONCATENATED MODULE: ./src/components/photo/photo-upload.js



function photo_upload_readURL(input) {
  if (input.files && input.files[0]) {
    var reader = new FileReader();

    reader.onload = function (e) {
      jquery_default()(input).closest('[data-photo]').find('[data-photo-preview]').css('background-image', 'url(' + e.target.result + ')');
      jquery_default()(input).closest('[data-photo]').find('[data-photo-preview]').hide();
      jquery_default()(input).closest('[data-photo]').find('[data-photo-preview]').fadeIn(650);
      jquery_default()(input).closest('[data-photo]').find('[data-photo-cancel]').fadeIn(230);
    };
...
jquery_default()('[data-photo-upload]').change(function () {
  photo_upload_readURL(this);
});
jquery_default()(document).on('click', '[data-photo-cancel]', function (e) {
  var $parent = jquery_default()(this).closest('[data-photo]');
  $parent.find('[data-photo-preview]').css('background-image', 'none');
  $parent.find('[data-photo-cancel]').fadeOut(230);
  $parent.find('[type=file]').val('');
  jquery_default()(this).trigger('photo:remove');
  e.preventDefault();
});
// CONCATENATED MODULE: ./src/components/photo/photo-preview.js


jquery_default()(document).ready(function () {
  jquery_default()(document).on('change', '[data-photo-preview-target]', function () {
    var target = jquery_default()(this).data('photo-preview-target');
    var value = jquery_default()(this).val();
    var $target = jquery_default()(target);
    $target.attr('src', value);
  });
  jquery_default()(document).find('[data-photo-preview-remove]').on('click', function () {
    var $photo = jquery_default()(this).parents('[data-photo]');
    var target = $photo.find('[data-photo-preview-target]').data('photo-preview-target');
    jquery_default()(target).attr('src', '');
    $photo.find('[data-photo-preview-target]').val('').trigger('change');
  });
});
// EXTERNAL MODULE: ./src/components/card/cardreveal.scss
var cardreveal = __webpack_require__(151);

// CONCATENATED MODULE: ./src/components/card/cardreveal.js


jquery_default()(document).ready(function () {
  jquery_default()(document).find('[data-card-reveal]').each(function () {
...
jquery_default()(document).ready(function () {
  jquery_default()(document).on('click, change', '[data-select]', function () {
    var self = this;
    var selected = jquery_default()(this).parents('[data-with-selection]').find('[data-select]:checked');
    var selections = [];
    selected.each(function (i) {
      var value = jquery_default()(this).val();
      var name = jquery_default()(this).attr('name');
      var $el = jquery_default()('<input type="hidden">');
      $el.attr({
        value: value,
        name: name
      });
    ...
    if (self.checked) {
      jquery_default()(self).parents('tr').addClass('active');
    } else {
      jquery_default()(self).parents('tr').toggleClass('active');
    }

    var target = jquery_default()(self).data('target');
    jquery_default()(target).html(selections);

    if (selections.length <= 0) {
      jquery_default()('[data-modal-toggle]').prop('disabled', true);
    } else {
      jquery_default()('[data-modal-toggle]').prop('disabled', false);
    } // select-all toggle


    var allCheckboxes = jquery_default()(self).parents('[data-with-selection]').find('[data-select]');
    jquery_default()('[data-select-all]').prop('indeterminate', false);

    if (selected.length === 0) {
      jquery_default()('[data-select-all]').prop('checked', false);
    } else if (allCheckboxes.length === selected.length) {
      jquery_default()('[data-select-all]').prop('checked', true);
    } else {
      jquery_default()('[data-select-all]').prop('indeterminate', true);
    }
  }); // $('[data-select]').change(function (e) {
  //   console.log(this.checked)
  // })

  jquery_default()('[data-select-all]').on('click, change', function () {
    var $parent = jquery_default()(this).parents('[data-with-selection]');
    var state = jquery_default()(this).data('select-all');
    ...
    jquery_default()(this).data('select-all', !state);
  });
});
...
jquery_default()(document).ready(function () {
  jquery_default()('[data-table]').each(function (i) {
    var options = jquery_default()(this).data('options') ? JSON.parse(jquery_default()(this).data('options')) : {}; // $(this).DataTable(options)
  });
});
// EXTERNAL MODULE: ./src/components/dragdrop/plugin.js
var dragdrop_plugin = __webpack_require__(153);

// EXTERNAL MODULE: ./src/components/dragdrop/dragdrop.scss
var dragdrop = __webpack_require__(154);
...
jquery_default()(document).ready(function () {
  jquery_default()('[data-dragdrop]').each(function (i) {
    var $instance = jquery_default()(this);
    var id = 'data-dragdrop' + i;
    var options = Object.assign({
      ...
      onDrop: function onDrop($item, container, _super) {
        $item.parents('[data-dragdrop]').children('[data-dragdrop-item]').each(function (j) {
          jquery_default()(this).find('[data-dragdrop-sort]').val(j);
          jquery_default()(this).find('ol, ul').find('[data-dragdrop-item]').each(function (k) {
            jquery_default()(this).find('[data-dragdrop-sort]').val(k);
          });
        });

        _super($item, container);

        var parent = $item.closest('[data-dragdrop-children]').parent('[data-dragdrop-item]');
        var key = parent.attr('data-dragdrop-key');
        $item.find('[data-dragdrop-parent]').val(key);
      }
    }, JSON.parse(jquery_default()(this).attr('data-dragdrop-options') || '{}'));
    $instance.attr('id', id);
  ...
  jquery_default()(document).on('click', '[data-dragdrop-item-remove]', function () {
    jquery_default()(this).closest('[data-dragdrop-item]').remove();
  });
});
// CONCATENATED MODULE: ./src/components/dropdown/dropdown.js

jquery_default()('.dropdown a, .sidebar a').keydown(function (e) {
  var $this = jquery_default()(this);
  ...
  switch (e.which) {
    case 38:
      // up arrow
      e.preventDefault();
      var focused = jquery_default()(':focus');
...
// EXTERNAL MODULE: ./src/components/file/file.scss
var file = __webpack_require__(156);

// CONCATENATED MODULE: ./src/components/file/file.js


jquery_default()(document).on('change', '.custom-file-input', function (event) {
  var input = event.target.files[0];
  var name = input.name;
  jquery_default()(this).next('.custom-file-label').attr('data-content', name);
  jquery_default()(this).next('.custom-file-label').addClass('selected').html(name);
});
jquery_default()(document).find('input[type=file]').change(function () {
  var fieldVal = jquery_default()(this).val(); // Change the node's value by removing the fake path (Chrome)

  fieldVal = fieldVal.replace("C:\\fakepath\\", '');

  if (fieldVal != undefined || fieldVal != '') {
    jquery_default()(this).next('.custom-file-label').attr('data-content', fieldVal);
    jquery_default()(this).next('.custom-file-label').text(fieldVal);
  }
});
// CONCATENATED MODULE: ./src/components/forms/fields.js

jquery_default()(document).ready(function () {
  jquery_default()(document).on('input change', ':input', function () {
    jquery_default()(this).closest('.form-group').find('.error-text').remove();
  });
  jquery_default()(document).on('forminvalid', 'form', function () {
    if (jquery_default()('.form-control.is-invalid').length) {
      jquery_default()('.form-control.is-invalid').first().focus();
    }
  }); // Make label act like buttons
  // when only using keyboards.

  jquery_default()(document).on('keypress', 'label', function (e) {
    switch (e.keyCode) {
      case 13: // enter

      case 32:
        // space
        jquery_default()('#' + jquery_default()(this).attr('for')).trigger('click');
        e.preventDefault();
        break;
    }
  });
  jquery_default()(document).on('keypress', 'span[role=button]', function (e) {
    switch (e.keyCode) {
      case 13: // enter
...
jquery_default()(document).ready(function () {
  // On load, show the modal if certain
  // URL parameters are met.
  var url = window.location.href;

  if (url.indexOf('modal=true') != -1) {
    var target = getUrlParam('id');
    jquery_default()('#' + target).modal('show');
    jquery_default()('#' + target).find(':input:enabled:visible:first').focus();
  } // Push the url params on button click


  jquery_default()(document).find('[data-toggle=modal]').on('click', function () {
    var id = jquery_default()(this).attr('data-target');
    var newurl = window.location.protocol + '//' + window.location.host + window.location.pathname + '?modal=true&id=' + id.replace('\#', '');
    window.history.pushState({
      path: newurl
    }, document.title, newurl);
  });
  jquery_default()(document).find('[data-dismiss=modal]').on('click', function () {
    var id = jquery_default()(this).parents('.modal').attr('id');
    var newurl = window.location.protocol + '//' + window.location.host + window.location.pathname + '?modal=false&id=' + id.replace('\#', '');
    window.history.pushState({
      path: newurl
    }, document.title, newurl);
  });
...
jquery_default()(document).ready(function () {
  jquery_default()(document).on('click', '[data-toggle=modal]', function (e) {
    var target = jquery_default()(this).data('target');
    jquery_default()(target).appendTo('body');
  });
});
// EXTERNAL MODULE: ./src/components/reveal/reveal.js
var reveal = __webpack_require__(160);

// EXTERNAL MODULE: ./node_modules/list.js/src/index.js
...
jquery_default()(document).ready(function () {
  jquery_default()(document).find('[data-toggle=search]').each(function (i, el) {
    var $this = jquery_default()(el);
    var id = $this.attr('id');
    var options = Object.assign({
      valueNames: ['name', {
        data: ['name']
    ...
    var list = new src_default.a(id, options);
  });
});
// CONCATENATED MODULE: ./src/components/settings/settings.js

jquery_default()(document).ready(function () {
  // On Load
  jquery_default()('[data-settings]').each(function () {
    var $this = jquery_default()(this);
    var $target = jquery_default()($this.data('target'));
  ...
  jquery_default()(document).on('click change', '[data-settings]', function () {
    var $this = jquery_default()(this);
    var key = $this.data('settings');
...
jquery_default()(document).ready(function () {
  jquery_default()('[data-sidebar-toggle]').on('click', function (e) {
    e.preventDefault();
    var target = jquery_default()(this).data('target');

    if (!target) {
      target = (_readOnlyError("target"), '[data-sidebar]');
    }
...
jquery_default()(document).ready(function () {
  if (jquery_default()(document).find('[data-sticky]').length) {
    var $elements = jquery_default()('[data-sticky]');
    $elements.each(function (i, el) {
      new IntersectionObserver(function (e, observer) {
        var t = e[0].target;
        var target = jquery_default()(t).data('sticky');

        if (e[0].intersectionRatio > 0) {
          document.documentElement.removeAttribute('class');
          jquery_default()(target).removeClass(jquery_default()(target).data('sticky-class'));
        } else {
          document.documentElement.setAttribute('class', 'stuck');
          jquery_default()(target).addClass(jquery_default()(target).data('sticky-class'));
        }
      }).observe(el);
    });
  }
...
var naturalSort = __webpack_require__(161),
  getByClass = __webpack_require__(9),
  extend = __webpack_require__(10),
  ...
  getAttribute = __webpack_require__(162),
  toArray = __webpack_require__(12);
...
module.exports = function(id, options, values) {
  ...
  var self = this,
    init,
    Item = __webpack_require__(14)(self),
    addAsync = __webpack_require__(163)(self),
    initPagination = __webpack_require__(164)(self);
  ...
  init = {
    start: function() {
      ...
      self.parse        = __webpack_require__(165)(self);
      self.templater    = __webpack_require__(166)(self);
      self.search       = __webpack_require__(167)(self);
      self.filter       = __webpack_require__(168)(self);
      self.sort         = __webpack_require__(169)(self);
      self.fuzzySearch  = __webpack_require__(170)(self, options.fuzzySearch);

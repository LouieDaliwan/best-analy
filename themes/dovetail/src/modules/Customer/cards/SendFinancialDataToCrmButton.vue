    ...
    sendToCrm () {
      ...
      this.getReportData().then(response => {
        ...
        let data = {
          ...
          Revenue: this.resource.data.profit_and_loss.Revenue.Year3 || '0',
          CostofGoodsSold: this.resource.data.profit_and_loss.CostOfGoodsSold.Year3 || '0',
          // it should be 0?
          OtherExpenses: 0,
          // OtherExpenses: this.resource.data.profit_and_loss.OtherExpenses),

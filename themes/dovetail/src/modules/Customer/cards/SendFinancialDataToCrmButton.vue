    ...
    sendToCrm () {
      ...
      this.getReportData().then(response => {
        ...
        let data = {
          ...
          Revenue: JSON.stringify(this.resource.data.profit_and_loss.Revenue.Year3),
          CostofGoodsSold: JSON.stringify(this.resource.data.profit_and_loss.CostOfGoodsSold.Year3),
          // it should be 0?
          OtherExpenses: 0,
          // OtherExpenses: JSON.stringify(this.resource.data.profit_and_loss.OtherExpenses),
          NonOperatingExpenses: JSON.stringify(this.resource.data.profit_and_loss.OtherExpenses['Non-Operating expenses (NOE)'].Year3 || {}),
          OperatingLossProfit: JSON.stringify(this.resource.data.profit_and_loss.OtherExpenses['Operating (loss)/profit'].Year3 || {}),
          Depreciation: JSON.stringify(this.resource.data.profit_and_loss.OtherExpenses['Depreciation'].Year3 || {}),
          Taxes: JSON.stringify(this.resource.data.profit_and_loss.OtherExpenses['Taxes'].Year3 || {}),
          NetLossProfits: this.resource.data.profit_and_loss.NetProfit.Year3,
          FixedAssets: this.resource.data.profit_and_loss.FixedAssets['Fixed Assets'].Year3,
          TotalLiabilities: JSON.stringify(this.resource.data.profit_and_loss.FixedAssets['Total Liabilities'].Year3),
          StockholdersEquity: this.resource.data.profit_and_loss.FixedAssets["Stockholders' Equity"].Year3,
          Marketing: JSON.stringify(this.resource.data.profit_and_loss.Marketing.Year3),
          Rent: JSON.stringify(this.resource.data.profit_and_loss.Rent.Year3),
          Salaries: JSON.stringify(this.resource.data.profit_and_loss.Salaries.Year3),
          LicensingFees: JSON.stringify(this.resource.data.profit_and_loss['Licensing Fees'].Year3),
          VisaEmploymentFees: JSON.stringify(this.resource.data.profit_and_loss['Visa / Employment Fees'].Year3),
        }

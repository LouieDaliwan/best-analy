<template>
  <v-card>
    <v-card-text class="pa-7">
      ...
      <v-divider class="mb-5"></v-divider>
      <canvas class="mb-5" ref="chart-el" width="400" height="200" v-if="value.ratings.answered_index != 0 && value.latestStatement != null"></canvas>
      <v-card v-else flat>
      ...
      <v-list v-if="value.latestStatement">

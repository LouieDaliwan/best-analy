  ...
  methods: {
    ...
    askUserToResetPermission () {
      this.showDialog({
        ...
        text: 'Resetting the permissions table will break your existing users\' established roles. Though the application will try to rebuild the permissions table, there is no guarantee all items will be restored. In fact, any manually added permission will not be recovered. You might need to setup the user roles manually again. Click outside the dialogbox if you don\'t want to proceed. Are you sure yout want to reset permissions?',
        buttons: {
          cancel: { show: false, color: 'link' },
          action: {
